 ...
 * @since   1.5
 */
public final class ScannerWithDelimiterAccess implements Iterator<String>, Closeable {
    ...
    // Internal matcher used for finding delimiters and results
    private Matcher matcher;
    
    // The delimiter that was found after the result. MatchResult seams heavy weight, it's a new Matcher.
    private String delimiterMatch;
    ...
    private Pattern integerPattern() {
        if (integerPattern == null) {
            integerPattern = Pattern.compile(buildIntegerPatternString());
        }
     ...
     */
    private ScannerWithDelimiterAccess(Readable source, Pattern pattern) {
     ...
     *         interface
     */
    public ScannerWithDelimiterAccess(Readable source) {
     ...
     */
    public ScannerWithDelimiterAccess(InputStream source) {
     ...
     *         does not exist
     */
    public ScannerWithDelimiterAccess(InputStream source, String charsetName) {
     ...
     */
    public ScannerWithDelimiterAccess(File source) throws FileNotFoundException {
     ...
     *         not found
     */
    public ScannerWithDelimiterAccess(File source, String charsetName)
        throws FileNotFoundException
    {
        this(Objects.requireNonNull(source), toDecoder(charsetName));
    }

    private ScannerWithDelimiterAccess(File source, CharsetDecoder dec)
        throws FileNotFoundException
    {
     ...
     * @since   1.7
     */
    public ScannerWithDelimiterAccess(Path source)
        throws IOException
    {
     ...
     * @since   1.7
     */
    public ScannerWithDelimiterAccess(Path source, String charsetName) throws IOException {
        this(Objects.requireNonNull(source), toCharset(charsetName));
    }

    private ScannerWithDelimiterAccess(Path source, Charset charset)  throws IOException {
     ...
     */
    public ScannerWithDelimiterAccess(String source) {
     ...
     */
    public ScannerWithDelimiterAccess(ReadableByteChannel source) {
     ...
     *         does not exist
     */
    public ScannerWithDelimiterAccess(ReadableByteChannel source, String charsetName) {
     ...
     * @return this scanner
     */
    public ScannerWithDelimiterAccess useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public ScannerWithDelimiterAccess useLocale(Locale locale) {
     ...
     */
    public ScannerWithDelimiterAccess useRadix(int radix) {
    ...
    /**
     * Get the delimiter found with the last result.
     * 
     * @return The delimiter that was found after the last result.
     */
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public ScannerWithDelimiterAccess skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @since 1.6
     */
    public ScannerWithDelimiterAccess reset() {
