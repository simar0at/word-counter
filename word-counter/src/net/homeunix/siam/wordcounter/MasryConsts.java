...
public class MasryConsts {
	...
	public static final String[][] masry_prefixes_nouns_stopwords = new String[][]{
		new String[] {"ب", "في", "عن", "علي", "دي", "ده", "هو", "هي", "ان", "كان", "او", "انو", "ما", "بن", "ال", "مع", "من", "بن", "ين", "كل", "كن", "يل", "اد", "قى", "بس", "غايه", "لو", "يس", "ون", "دا", "يا"},
	...
	public static final String[][] masry_prefixes_verbs_stopwords = new String[][]{
		...
		new String[] {"من", "في", "عن", "علي", "الى", "ان", "جي", "بعد", "بن", "انو", "ال", "ل", "ب", "مش", "بق", "وم", "لا", "بق", "مين", "ها", "تيم", "يناير"},
	...
	public static final String[][] masry_postfixes_verbs_stopwords = new String[][]{
		new String[] {"هو", "هي", "دي", "او", "ان", "ال", "يا", "جي", "لو", "عا", "عي", "الجي"},
		new String[] {"ال", "مع", "تا", "حس"},
		new String[] {"ال", "مش", "بق", "دا"},
		new String[] {"دي", "ما", "ال", "زي", "هي", "ل", "ب", "الجي", "بق", "دا", "عمر", "ماي"},
		new String[] {"في", "من", "عن", "فيا", "اخ", "تح", "بق", "صل", "بن", "أن", "إن", "لس", "دا", "عز"}
	};
	public static final String[] masry_prefixes_indet = {"و", "ب"};
	public static final String[][] masry_prefixes_indet_stopwords = new String[][]{
		new String[] {"أو", "صل", "يا", "لاد", "قت", "عمر", "يه", "جد", "جدي", "جده", "جه", "صف", "وده", "يناير"},
	...
	public static final String[][] masry_postfixes_indet_stopwords = new String[][]{
		new String[] {"إلل", "هو", "هم", "عل", "ال", "إل", "سم", "أو", "ما", "هي", "بن", "مش", "تان", "حوال", "حت", "كبر", "لا", "لو", "حسن", "بق", "صدق", "دا", "قدر", "وما", "بس"},
		new String[] {"إللي", "دي", "ده", "بن", "ما", "هي", "لين", "مل", "لو", "شر", "الأمري", "هنا", "حر"},
		new String[] {"هي", "الامري"},
		new String[] {"سن", "دي", "ال", "بن", "هي", "كد", "مر", "جه", "حاج", "مدين", "اللغ", "اى", "صل", "قاهر", "لست", "القاهر", "جامع", "الجامع", "لجامع", "للجامع", "ثور", "أم", "كلم", "لس", "حمل", "شوي", "مد", "فتر", "ودا", "يا", "حي", "بس", "سعاد"},
		new String[] {"ودا", "إنت"},
		new String[] {"يا"},
		new String[] {"او", "انو", "تح", "حا"},
		new String[] {"لا", "ودا", "بس"}		
	};
